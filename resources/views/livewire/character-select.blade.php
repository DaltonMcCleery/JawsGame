<section class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
    ...
    <div class="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 xl:gap-x-8">
        <a class="group cursor-pointer" wire:click="userSelectedCharacter('monitor')">
            <div class="w-full aspect-w-1 aspect-h-1 rounded-lg overflow-hidden sm:aspect-w-2 sm:aspect-h-3">
                ...
                @if($game->monitor)
                    <p class="absolute top-0 left-0 w-full h-full flex justify-center items-center font-bold text-white text-2xl">
                        SELECTED
                    </p>
                @endif
            </div>
        ...
        <a class="group cursor-pointer" wire:click="userSelectedCharacter('player')">
