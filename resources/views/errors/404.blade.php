    ...
    <section class="w-full">
        <div class="relative min-h-[400px]">
            <div class="absolute inset-0">
                <img class="h-full w-full object-cover" src="{{ asset('images/404.jpeg') }}" alt="JAWS Logo">
            ...
            <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8 flex flex-col justify-center items-center">
                <p class="text-sm font-semibold text-white text-opacity-50 uppercase tracking-wide">404 error</p>
                <h1 class="text-center text-xl font-extrabold tracking-tight md:text-4xl text-white">
                    Must have gone under the boat...
                </h1>
                <div class="mt-6">
